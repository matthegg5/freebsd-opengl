...
//stb_image.h texture implementation
...
int main(int, char**) {
    ...
    window = glfwCreateWindow(SCR_WIDTH,SCR_HEIGHT, "FreeBSD OpenGL Engine", NULL, NULL);
	...
	image = stbi_load("res/container2.png", &textureWidth, &textureHeight, &nrChannels, 0);
	...
	image = stbi_load("res/container2_specular.png", &textureWidth, &textureHeight, &nrChannels, 0);
	...
	glm::mat4 projection = glm::perspective(camera.GetZoom(), (GLfloat)SCR_WIDTH / (GLfloat)SCR_HEIGHT, 0.1f, 1000.0f); //perspective
